...
def simulate_policy_losses(exposures, claim_rows):
    ...
    maximum_loss = StochasticScalar(np.array(exposures["maximum_loss"]))[row_index]
    policy_limit = StochasticScalar(np.array(exposures["policy_limit"]))[row_index]
    deductible = StochasticScalar(np.array(exposures["policy_deductible"]))[row_index]
    c = StochasticScalar(np.array(exposures["mbbefd_c"]))[row_index]
